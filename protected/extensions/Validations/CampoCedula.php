    ...
    protected function validateAttribute($object, $attribute) {
        ...
        if ($tipo == 'C') {
            if (strlen($ncedula) == 10) {
                if ($c >= '1' && $c <= '24') {//Pertenece a alguna provincia
                    if ($ncedula[2] < 6) {//3er dígito menor a 6
                        ...
                        if ($last_digit == $ncedula[9]) {
                            ...
                            $this->addError($object, $attribute, 'Número de identificación no válido (el último dígito no es correcto)!');
                        }
                    } else {
                ...
                $this->addError($object, $attribute, 'Su identificación tiene un largo incorrecto (debe ser de 10 caracteres)');
            }
        } elseif ($tipo == '') {
