...
-- -----------------------------------------------------
-- Table `mcrmira`.`credito_devolucion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mcrmira`.`credito_devolucion` ;

CREATE TABLE IF NOT EXISTS `mcrmira`.`credito_devolucion` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `cantidad` DECIMAL(10,2) NOT NULL,
  `estado` ENUM('NO DEVUELTO','DEVUELTO') NOT NULL,
  `usuario_devolucion_id` INT NULL,
  `fecha_devolucion` DATETIME NULL,
  `credito_deposito_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_credito_devolucion_credito_deposito1_idx` (`credito_deposito_id` ASC),
  CONSTRAINT `fk_credito_devolucion_credito_deposito1`
    FOREIGN KEY (`credito_deposito_id`)
    REFERENCES `mcrmira`.`credito_deposito` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
