...
CREATE TABLE IF NOT EXISTS `mcrmira`.`persona` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_cliente_cliente_estado1_idx` (`cliente_estado_id` ASC),
  ...
  CONSTRAINT `fk_cliente_cliente_estado1`
    FOREIGN KEY (`cliente_estado_id`)
...
-- -----------------------------------------------------
-- Table `mcrmira`.`entidad_bacaria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mcrmira`.`entidad_bacaria` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NOT NULL,
  `direccion_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
