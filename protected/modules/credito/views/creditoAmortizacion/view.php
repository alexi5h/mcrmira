...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . CreditoAmortizacion::label(2), 'icon' => 'list', 'url' => array('index')),
...
<?php $this->widget('bootstrap.widgets.TbDetailView',array(
	...
	'attributes' => array(
             ...
             array(
			'name' => 'credito_id',
			'value'=>($model->credito !== null) ? CHtml::link($model->credito, array('/credito/view', 'id' => $model->credito->id)).' ' : null,
			'type' => 'html',
		),
	),
)); ?>
