...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . CreditoDeposito::label(2), 'icon' => 'list', 'itemOptions'=>array('class'=>'active')),
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'List') ?> <?php echo CreditoDeposito::label(2) ?>    </legend>
