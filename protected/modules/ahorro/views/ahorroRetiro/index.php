...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . AhorroRetiro::label(2), 'icon' => 'list', 'itemOptions'=>array('class'=>'active')),
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'List') ?> <?php echo AhorroRetiro::label(2) ?>    </legend>
