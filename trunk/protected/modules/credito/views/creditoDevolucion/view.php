...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . CreditoDevolucion::label(2), 'icon' => 'list', 'url' => array('index')),
...
<?php $this->widget('bootstrap.widgets.TbDetailView',array(
	...
	'attributes' => array(
             ...
             'fecha_devolucion',
             array(
			'name' => 'credito_deposito_id',
			'value'=>($model->creditoDeposito !== null) ? CHtml::link($model->creditoDeposito, array('/creditoDeposito/view', 'id' => $model->creditoDeposito->id)).' ' : null,
			'type' => 'html',
		),
	),
)); ?>
