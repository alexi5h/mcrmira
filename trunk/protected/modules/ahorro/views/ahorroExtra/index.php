...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . AhorroExtra::label(2), 'icon' => 'list', 'itemOptions'=>array('class'=>'active')),
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'List') ?> <?php echo AhorroExtra::label(2) ?>    </legend>
