...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . AhorroDeposito::label(2), 'icon' => 'list', 'itemOptions'=>array('class'=>'active')),
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'List') ?> <?php echo AhorroDeposito::label(2) ?>    </legend>
