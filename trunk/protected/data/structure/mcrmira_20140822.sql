...
CREATE TABLE `ahorro_deposito` (
  ...
  CONSTRAINT `fk_deposito_pago1` FOREIGN KEY (`pago_id`) REFERENCES `ahorro` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `credito` (
  ...
  `interes` decimal(3,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
