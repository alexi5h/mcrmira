...
-- -----------------------------------------------------
-- Table `mcrmira`.`ahorro_detalle`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mcrmira`.`ahorro_detalle` ;

CREATE TABLE IF NOT EXISTS `mcrmira`.`ahorro_detalle` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `cantidad` DECIMAL(10,2) NOT NULL,
  `fecha` DATE NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_ahorro_detalle_ahorro1_idx` (`ahorro_id` ASC),
  CONSTRAINT `fk_ahorro_detalle_ahorro1`
